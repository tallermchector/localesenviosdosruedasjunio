  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'pulse-dot': {
          '0%': { transform: 'scale(0.95)', boxShadow: '0 0 0 0 rgba(255, 236, 0, 0.7)' },
          '70%': { transform: 'scale(1)', boxShadow: '0 0 0 10px rgba(255, 236, 0, 0)' },
          '100%': { transform: 'scale(0.95)', boxShadow: '0 0 0 0 rgba(255, 236, 0, 0)' },
        },
        'scroll-track': {
